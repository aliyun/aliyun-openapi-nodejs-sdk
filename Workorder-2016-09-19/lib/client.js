...
class Client extends RPCClient {
  ...
  /**
   * @param {Long} FaqUserId - faqUserId. required.
   */
  queryQuestionCountByAccount(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'FaqUserId')) {
      throw new TypeError('parameter "FaqUserId" is required');
    }

    return this.request('QueryQuestionCountByAccount', params, options);
  }
   ...
   */
  queryQuestionFromOtherSite(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'FaqUserId')) {
      throw new TypeError('parameter "FaqUserId" is required');
    }

    return this.request('QueryQuestionFromOtherSite', params, options);
  }

  /**
   * @param {String} QuestionVid - questionVid. required.
   * @param {Long} QuestionNoteId - questionNoteId. optional.
   * @param {Integer} Status - status. optional.
   * @param {Long} AuthorizationTypeId - authorizationTypeId. optional.
   * @param {String} AuthorizationTypeName - authorizationTypeName. optional.
   * @param {Integer} ShowHidden - showHidden. optional.
   */
  queryRecordList(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'QuestionVid')) {
      throw new TypeError('parameter "QuestionVid" is required');
    }

    return this.request('QueryRecordList', params, options);
  }
