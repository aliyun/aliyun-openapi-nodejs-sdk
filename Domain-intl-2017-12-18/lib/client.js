...
class Client extends RPCClient {
   ...
   * @param {RepeatList} DomainName - domainNameList. required.
   */
  saveBatchTaskForUpdatingContactInfo(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'RegistrantProfileId')) {
      throw new TypeError('parameter "RegistrantProfileId" is required');
    }
    ...
    return this.request('SaveBatchTaskForUpdatingContactInfo', params, options);
  }
   ...
   * @param {Boolean} AliyunDns - aliyunDns. optional.
