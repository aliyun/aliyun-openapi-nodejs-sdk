...
class Client extends ROAClient {
  constructor(config) {
    config.apiVersion = '2017-02-13';
    super(config);
  }

  alertCount(query, headers = {}, opts = {}) {
    const path = `/alarms/countAlert`;
    return this.get(path, query, headers, opts);
  }

  batchDeleteAlerts(query, headers = {}, opts = {}) {
    const path = `/alarms/batchDelete`;
    return this.get(path, query, headers, opts);
  }
  ...
  listEvents(projectName, query, headers = {}, opts = {}) {
  ...
  listUnhealthyInstancesForGroup(projectName, groupId, query, headers = {}, opts = {}) {
