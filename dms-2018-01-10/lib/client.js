...
class Client extends RPCClient {
   ...
   * @param {String} parentId - parentId. optional.
   * @param {Boolean} subUser - subUser. optional.
   * @param {String} wfOrderId - wfOrderId. required.
   * @param {String} workflowOrderInfoId - workflowOrderInfoId. required.
   * @param {String} workflowOrderNodeInfoId - workflowOrderNodeInfoId. required.
   * @param {Boolean} agree - agree. required.
   * @param {String} auditComment - auditComment. required.
   */
  approvalOrder(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'userId')) {
      throw new TypeError('parameter "userId" is required');
    }

    if (!hasOwnProperty(params, 'wfOrderId')) {
      throw new TypeError('parameter "wfOrderId" is required');
    }

    if (!hasOwnProperty(params, 'workflowOrderInfoId')) {
      throw new TypeError('parameter "workflowOrderInfoId" is required');
    }

    if (!hasOwnProperty(params, 'workflowOrderNodeInfoId')) {
      throw new TypeError('parameter "workflowOrderNodeInfoId" is required');
    }

    if (!hasOwnProperty(params, 'agree')) {
      throw new TypeError('parameter "agree" is required');
    }

    if (!hasOwnProperty(params, 'auditComment')) {
      throw new TypeError('parameter "auditComment" is required');
    }

    return this.request('ApprovalOrder', params, options);
  }
   ...
   * @param {String} workflowOrderNodeInfoId - workflowOrderNodeInfoId. required.
   */
  getApprovalOrderDetail(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'userId')) {
      throw new TypeError('parameter "userId" is required');
    }
    ...
    return this.request('GetApprovalOrderDetail', params, options);
  }
   ...
   */
  getApprovalOrderList(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'userId')) {
      throw new TypeError('parameter "userId" is required');
    }
    ...
    return this.request('GetApprovalOrderList', params, options);
  }
   ...
   * @param {String} parentId - parentId. optional.
   * @param {Boolean} subUser - subUser. optional.
   * @param {String} actions - actions. required.
   */
  getUserDailyMobileOperations(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'userId')) {
      throw new TypeError('parameter "userId" is required');
    }
    ...
    return this.request('GetUserDailyMobileOperations', params, options);
  }
   ...
   * @param {String} vpcType - vpcType. optional.
