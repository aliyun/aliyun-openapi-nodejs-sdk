...
class Client extends RPCClient {
   ...
   */
  onsMessageGetByIndex(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'OnsRegionId')) {
      throw new TypeError('parameter "OnsRegionId" is required');
    }
    ...
    return this.request('OnsMessageGetByIndex', params, options);
  }
   ...
   * @param {Long} EndTime - endTime. required.
   */
  onsMessageQueryByTopic(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'OnsRegionId')) {
      throw new TypeError('parameter "OnsRegionId" is required');
    }
    ...
    return this.request('OnsMessageQueryByTopic', params, options);
  }
   ...
   * @param {Long} endTime - endTime. required.
   */
  onsTraceQueryByMsgTopic(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'OnsRegionId')) {
      throw new TypeError('parameter "OnsRegionId" is required');
    }
    ...
    return this.request('OnsTraceQueryByMsgTopic', params, options);
  }
   ...
   * @param {String} ConsumerId - consumerId. optional.
   * @param {String} Topic - topic. optional.
