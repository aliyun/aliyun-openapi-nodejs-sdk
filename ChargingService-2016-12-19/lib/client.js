...
class Client extends RPCClient {
   ...
   * @param {String} data - data. required.
   */
  checkPurchaseStatus(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'data')) {
      throw new TypeError('parameter "data" is required');
    }

    return this.request('CheckPurchaseStatus', params, options);
  }
   ...
   * @param {String} data - data. required.
   */
  getPingcode(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'data')) {
      throw new TypeError('parameter "data" is required');
    }

    return this.request('GetPingcode', params, options);
  }

  /**
   * @param {String} data - data. required.
   */
  getUidByPingcode(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'data')) {
      throw new TypeError('parameter "data" is required');
    }

    return this.request('GetUidByPingcode', params, options);
  }
