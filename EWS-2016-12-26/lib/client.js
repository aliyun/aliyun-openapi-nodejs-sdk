...
class Client extends RPCClient {
  ...
  /**
   * @param {Long} callerUid - userId. required.
  ...
  appScale(params = {}, options = {}) {
    ...
    return this.request('AppScale', params, options);
  }

  /**
   * @param {Long} AppId - appId. required.
   * @param {RepeatList} NeedScaleInAppInstanceIds - needScaleInAppInstanceIds. required.
   */
  appScaleIn(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'AppId')) {
      throw new TypeError('parameter "AppId" is required');
    }

    if (!hasOwnProperty(params, 'NeedScaleInAppInstanceIds')) {
      throw new TypeError('parameter "NeedScaleInAppInstanceIds" is required');
    }

    return this.request('AppScaleIn', params, options);
  }
   ...
   * @param {Long} AliUid - aliUid. required.
   * @param {Long} AppId - appId. required.
   * @param {String} TargetVmInnerIp - targetVmInnerIp. required.
   * @param {String} TargetVmIp - targetVmIp. required.
   * @param {String} TargetHostUser - targetHostUser. required.
   * @param {String} AppVmFamily - appVmFamily. required.
   * @param {String} AppUid - appUid. required.
   */
  ftpMigrate(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'AliUid')) {
      throw new TypeError('parameter "AliUid" is required');
    }
    ...
    if (!hasOwnProperty(params, 'TargetVmInnerIp')) {
      throw new TypeError('parameter "TargetVmInnerIp" is required');
    }

    if (!hasOwnProperty(params, 'TargetVmIp')) {
      throw new TypeError('parameter "TargetVmIp" is required');
    }

    if (!hasOwnProperty(params, 'TargetHostUser')) {
      throw new TypeError('parameter "TargetHostUser" is required');
    }

    if (!hasOwnProperty(params, 'AppVmFamily')) {
      throw new TypeError('parameter "AppVmFamily" is required');
    }
    ...
    return this.request('FtpMigrate', params, options);
  }
  ...
  /**
   * @param {String} InstanceId - instanceUid. required.
   * @param {String} Entry - entry. required.
   * @param {String} Period - period. required.
   * @param {String} StartTime - startTime. required.
   * @param {String} EndTime - endTime. required.
