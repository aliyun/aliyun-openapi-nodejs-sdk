...
class Client extends RPCClient {
   ...
   * @param {String} InstanceId - instanceId. optional.
   */
  onsDLQMessageGetById(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'PreventCache')) {
      throw new TypeError('parameter "PreventCache" is required');
    }
    ...
    return this.request('OnsDLQMessageGetById', params, options);
  }
   ...
   * @param {String} InstanceId - instanceId. optional.
   */
  onsDLQMessagePageQueryByGroupId(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'PreventCache')) {
      throw new TypeError('parameter "PreventCache" is required');
    }
    ...
    return this.request('OnsDLQMessagePageQueryByGroupId', params, options);
  }
   ...
   * @param {String} InstanceId - instanceId. optional.
   */
  onsDLQMessageResendById(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'PreventCache')) {
      throw new TypeError('parameter "PreventCache" is required');
    }
    ...
    return this.request('OnsDLQMessageResendById', params, options);
  }
   ...
   * @param {String} GroupId - groupId. required.
   */
  onsGroupSubDetail(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'PreventCache')) {
      throw new TypeError('parameter "PreventCache" is required');
    }
    ...
    return this.request('OnsGroupSubDetail', params, options);
  }
   ...
   * @param {String} Topic - topic. required.
   */
  onsTopicSubDetail(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'PreventCache')) {
      throw new TypeError('parameter "PreventCache" is required');
    }
    ...
    return this.request('OnsTopicSubDetail', params, options);
  }
