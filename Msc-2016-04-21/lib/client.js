...
class Client extends RPCClient {
  ...
  /**
   * @param {RepeatList} MobileList - mobileList. required.
   * @param {RepeatList} TaobaoNickList - taobaoNickList. required.
  ...
  createMixMessage(params = {}, options = {}) {
    ...
    if (!hasOwnProperty(params, 'TaobaoNickList')) {
      throw new TypeError('parameter "TaobaoNickList" is required');
    }
