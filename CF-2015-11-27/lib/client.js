...
class Client extends RPCClient {
   ...
   * @param {String} UserFeedback - userFeedback. required.
   ...
   */
  accountFeedback(params = {}, options = {}) {
    ...
    return this.request('AccountFeedback', params, options);
  }
  ...
  accountQuery(params = {}, options = {}) {
    ...
    return this.request('AccountQuery', params, options);
  }

  /**
   * @param {String} Serno - serno. required.
   * @param {String} Token - token. required.
   * @param {String} SessionId - sessionId. required.
   * @param {String} RemoteIp - remoteIp. required.
   * @param {String} Sig - sig. required.
   * @param {String} AppKey - appKey. required.
   * @param {String} SceneId - scene. optional.
   */
  authenticate(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'Serno')) {
      throw new TypeError('parameter "Serno" is required');
    }
   ...
   * @param {String} AliDecision - aliDecision. required.
   * @param {String} DenyReason - denyReason. required.
   * @param {String} CFTimestamp - timestamp. required.
   * @param {String} AppToken - appToken. required.
   */
  cfAccountFeedback(params = {}, options = {}) {
    ...
    if (!hasOwnProperty(params, 'CFTimestamp')) {
      throw new TypeError('parameter "CFTimestamp" is required');
    }
