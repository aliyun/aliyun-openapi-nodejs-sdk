...
class Client extends RPCClient {
   ...
   * @param {String} SynchronizationObject - synchronizationObject. required.
   ...
   * @param {Initialization} Initialization - undefined. required.
   */
  configurationSynchronizationJob(params = {}, options = {}) {
    if (!hasOwnProperty(params, 'SynchronizationJobId')) {
      throw new TypeError('parameter "SynchronizationJobId" is required');
    }

    if (!hasOwnProperty(params, 'SynchronizationObject')) {
      throw new TypeError('parameter "SynchronizationObject" is required');
    }
    ...
    if (!hasOwnProperty(params, 'Initialization')) {
      throw new TypeError('parameter "Initialization" is required');
    }

    return this.request('ConfigurationSynchronizationJob', params, options);
  }
